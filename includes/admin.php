<?php
	...
	function maintenance_admin_setup() {
		global	$maintenance_variable;
				$maintenance_variable->options_page = add_menu_page('Maintenance', 'Mód údržby', 'manage_options', 'maintenance', 'manage_options',  MAINTENANCE_URI . '/images/icon-small.png');
